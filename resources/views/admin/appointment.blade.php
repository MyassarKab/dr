  ...
  @endforeach()
                     ...
                     <div class="col-sm-9 mail_view">
                       ...
                       <div class="inbox-body  filter appointment{{$Item->id}}" style="display:none">
                         <div class="mail_heading row">
                           <div class="col-md-8">
                             <div class="btn-group">
                               ...
                               <form class="deleteform" action="\delete-appointment" method="post" style="display: inline-block;">
                               {{ csrf_field() }}
                         ...
                         <div class="view-mail">
                           <p>appointment in  <span style="font-weight: 800;" > {{$Item->date}}</span> in <span style="font-weight: 800;" >{{ $Item->clinic}}</span>  clinc   by <span style="font-weight: 800;" >{{$Item->name}}</span>  <br/>
