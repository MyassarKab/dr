          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @endif
                    <br />
                    <form id="demo-form2" action="\add-info" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        {{ csrf_field() }}
                      <div class="" id="exTab3">
                      ...
                      <div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active" id="1b">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="Address" name="address_en" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                        ...
                        <div class="tab-pane" id="2b">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="Address" name="address_ar" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
            ...
            <!-- <a href="map.html">edite MAP</a> -->
              <div class="col-md-6">
                ...
                <input type="text" id="latitude" placeholder="latitude" class="form-control" name="latitude">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="">Longitude</label>
                <input type="text" id="longitude" placeholder="longitude" class="form-control" name="longitude">
              </div>
            </div>
            <div class="col-md-12">
