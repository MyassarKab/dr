              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @endif
                    ...
                    <br />
                    <form id="demo-form2" action="\update-clinic\{{$clinic->id}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        {{ csrf_field() }}
                      <div class="" id="exTab3">
                      ...
                      <div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active" id="1b">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="name_en" required="required" class="form-control col-md-7 col-xs-12" value="{{$clinic->name_en}}">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="slug_en" required="required" class="form-control col-md-7 col-xs-12" value="{{$clinic->slug_en}}">
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="tab-pane" id="2b">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="name_ar" required="required" class="form-control col-md-7 col-xs-12" value="{{$clinic->name_ar}}">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="slug_ar" required="required" class="form-control col-md-7 col-xs-12" value="{{$clinic->slug_ar}}">
                            </div>
                          </div>
                          <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="control-label col-md-3 col-sm-3 col-xs-12 ">
                          <span  style="font-weight: bold;font-size: 1.2em;">Clinic Image <span class="required">*</span></span>
                        </div>
