                      ...
                      <div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active" id="1b">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="sp_name_en" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <textarea name="specialist_en" rows="5" cols="80"></textarea>
                            </div>
                          </div>
                        </div>
                        <!-- end -->
                        ...
                        <div class="tab-pane" id="2b">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="sp_name_ar" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <textarea name="specialist_ar" rows="5" cols="80"></textarea>
                            </div>
                          </div>
                         </div>
                           <!-- end -->
